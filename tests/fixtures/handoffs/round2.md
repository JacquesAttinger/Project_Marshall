...
You asked for the queen-side case to be covered too.
`castlingMoves()` now checks the crossed square in both directions, and the test has a mirrored position.
