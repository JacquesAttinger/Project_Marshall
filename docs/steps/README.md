...
| 04 | [`04_planning_phase.md`](04_planning_phase.md) | Haiku complexity classifier + autonomous `/marshall:plan` skill + `runPlanPhase()` (built) |
...
| 09 | [`09_ops_launchd_notifications_cli.md`](09_ops_launchd_notifications_cli.md) | launchd, caffeinate, ntfy push, `marshall status`, runbook (built; see [`../runbook.md`](../runbook.md)) |
