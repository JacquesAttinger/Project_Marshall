...
Source spec: [`../project_jarvis_plan.md`](../project_jarvis_plan.md).
...
| 04 | [`04_planning_phase.md`](04_planning_phase.md) | Haiku complexity classifier + autonomous `jarvis-plan` skill |
| 05 | [`05_implement_and_review_phase.md`](05_implement_and_review_phase.md) | `jarvis-implement` skill: `ship-plan` + Compose isolation + `code-review` loop |
...
| 09 | [`09_ops_launchd_notifications_cli.md`](09_ops_launchd_notifications_cli.md) | launchd, caffeinate, ntfy push, `jarvis status`, runbook |
